...
{\fontfamily{qcr}\selectfont stv} of type
{\fontfamily{qcr}\selectfont STV\_record}. In particular, we
demonstrate the termination property. The termination theorem is
instantiated in separate modules with particular
{\fontfamily{qcr}\selectfont STV\_record} values, such as ACT STV
...
realisation than made possibly by other frameworks (e.g.
